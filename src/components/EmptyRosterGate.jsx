    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 text-center">
      <div className="max-w-sm flex flex-col items-center gap-4">
        <div className="w-16 h-16 rounded-2xl gold-gradient flex items-center justify-center">
          <Icon name={isAdmin ? 'group_add' : 'lock'} filled className="text-black text-3xl" />
        </div>

        {isAdmin ? (
          <>
            <h1 className="font-headline-lg text-xl text-white">Create your first client</h1>
            ...
            <button
              ...
              className="gold-gradient text-black font-bold px-6 py-3 rounded-full flex items-center gap-2 hover:opacity-90 transition-opacity glow-gold"
            >
          ...
          <>
            <h1 className="font-headline-lg text-xl text-white">No workspace yet</h1>
            <p className="text-on-surface-variant text-sm">
